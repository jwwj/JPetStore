  ...
  寄运地址
   ...
   城市: </td><td><s:property value="account.city"/> 
    ...
    <form action="saveOrderAction?signon.userid=${userid }" method="post">
  			...
  			<input type="hidden" name="orders.billtolastname"  value="<s:property value="account.firstname" />" />
  			...
  			<input type="hidden" name="orders.shiptolastname"  value="<s:property value="account.firstname" />" />
